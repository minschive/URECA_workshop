    ...
    <script>
        ...
        function makeListHtml(list){
            ...
            list.forEach( el => {
                ...
                let userName = el.userName;  // 사용자 이름
                let model = el.model;        // 휴대폰 모델명
                let quantity = el.quantity;
                let totalPrice = el.totalPrice;
                let saleDate = el.saleDate;

                listHTML += `<tr style="cursor:pointer" data-saleId=\${saleId}>
                            <td>\${saleId}</td>
                            <td>\${userName}</td>
                            <td>\${model}</td>
                            <td>\${quantity}</td>
